        ...
        for url in urls:
            ...
            if settings == 'html':
                if html_content:
                    ...
                    html_contents, _ = self.fetch_html([url], {'extract_html': True})
            ...
            if settings == 'css':
                if css_content:
                    ...
                    _, extra_info = self.fetch_html([url], {'extract_css': True})
